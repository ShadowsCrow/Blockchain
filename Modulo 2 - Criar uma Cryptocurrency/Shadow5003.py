...
def mine_block(): 
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Hollywood', amount=1)
    block = blockchain.create_block(proof, previous_hash)
    response = {'message':'1 Shadow minerado',
                'index': block['index'],
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message':'Os nós tinham cadeias diferentes, então foram substituidos',
